...
export default function InfoSection() {
    return (
        <div style={{ backgroundColor: '#FDCB00', borderRadius: '50px' }} className='px-4 md:px-12 w-full mt-12 md:mt-24 flex flex-col md:flex-row items-center justify-between'>
            <div className='w-full md:w-1/2 flex flex-col items-center md:items-start pt-8 md:pt-14 md:pr-8'>
                <h1 className='text-white text-center md:text-left font-extrabold text-3xl md:text-5xl w-full'>Bizdagi gibrid <br /> o’qitish tizimi</h1>
            ...
            <img src='https://cambridgeonline.uz/_nuxt/img/Rectangle%20(1).6c73da8.png' className='w-full md:w-1/2 mt-8 md:mt-0' alt="illustration" />
        </div>
    );
}