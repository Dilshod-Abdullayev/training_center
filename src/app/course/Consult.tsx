...
export default function Consult() {
    return (
        <div className="mx-4 md:mx-14 w-full md:w-1/2 mt-10 border-2 border-sky-500 rounded-lg">
            <h1 className='font-extrabold text-sky-500 text-center text-xl md:text-2xl w-full'>
                Kurs bo‘yicha bepul maslahat oling!
            </h1>
            <div className="p-4 md:p-8">
                ...
                <div className="my-6 flex flex-col md:flex-row gap-4">
                    <select
                        name="select"
                        id="select"
                        className="block w-full md:w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm"
                    >
                ...
                <div className="flex justify-center">
                    <button className='bg-sky-500 flex items-center hover:bg-sky-700 text-white font-bold py-2 px-4 rounded'>
                        Batafsil <IoIosSend />
                    </button>
                </div>
            </div>
